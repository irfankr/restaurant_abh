define('ember-cli-selectize/components/ember-selectize', ['exports', 'ember', 'ember-new-computed', 'ember-getowner-polyfill'], function (exports, _ember, _emberNewComputed, _emberGetownerPolyfill) {
  'use strict';
  ...
  exports['default'] = _ember['default'].Component.extend({
          ...
          if (selection.then) {
            selection.then(function (resolved) {
              if (resolved) {
                ...
                _this5._selectize.clear();
                _this5._selectize.showInput();
              }
            });
          } else {
    ...
    */
    ...
    _componentToDOM: function _componentToDOM(componentName, data) {
      var componentLookup = (0, _emberGetownerPolyfill['default'])(this).lookup('component-lookup:main');
